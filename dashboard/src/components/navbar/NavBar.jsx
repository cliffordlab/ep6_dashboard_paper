...
const navBarStyles = (mode) => ({
    navbar: {
        ...
        position: "fixed",
        top: 0,
        borderBottom: `1px solid ${theme[mode].color}`,
    },
    navbarWrapper: {
        height: "100%",
        display: "flex",
